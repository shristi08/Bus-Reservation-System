...
import pyglet
import random
pyglet.font.add_file('Travel Bold Italic.ttf')
pyglet.font.add_file('Travel Bold.ttf')
pyglet.font.add_file('Travel Regular.ttf')
pyglet.font.add_file('Travel Italics.ttf')
pyglet.font.add_file('Travel Bold Italic.ttf')
...
Label(s_root, text="Created by Shristi Kumari \n", font=('Product Sans', 20)).pack(pady=25)
s_root.after(3000, s_root.destroy)
s_root.mainloop()
